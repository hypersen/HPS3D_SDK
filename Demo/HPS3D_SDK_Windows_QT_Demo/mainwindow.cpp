        ...
        if(event->AsyncEvent == ISubject_Event_DataRecvd)
        {
            switch(event->RetPacketType)/*Returns the packet data type*/
            {
                ...
                case FULL_ROI_PACKET:
                    ...
                    //HPS3D_RoiDepthCompound(&event->MeasureData,event->RetPacketType,FullRoiDistance);
                ...
                case SIMPLE_DEPTH_PACKET:
                    dist_average = event->MeasureData.simple_depth_data->distance_average;
                    break;
                default:
                    break;
            }
