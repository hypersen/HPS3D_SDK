...
/**
  * @brief	计算crc32的值，初始值为0xffffffff
  * @param[in]	data 存放数据的数组
  * @param[in]	len	要计算的字节数
  * @note
  * @see
  * @code
  * @retval	crc32结果
 ...
 *
 */
const uint16_t crc_ta_8[256]={ /* CRC字节表 */
...
/**
  * @brief	计算crc16的值，初始值为0xffffffff,多项式为CCITT标准
  * @param[in]	data 存放数据的数组
  * @param[in]	len	要计算的字节数
  * @note	CRC-CCITT 0x1021
  * @see
  * @code
  * @retval	crc16 CCITT计算结果
  */
